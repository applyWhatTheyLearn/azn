    ...
    EditorUI.prototype = {
        ...
        initEditorUI:function () {
            ...
            var popup = new baidu.editor.ui.Popup({
                ...
                _onImgClearButtonClick:function(name){
                    this.hide();
                    editor.execCommand('imagedel',name);
//                    var content = document.getElementById('w_detail');
//                    console.log(content[1].defaultValue);
//                    console.log(content.value);
//                    content.value='jjjjjj';
                },
                ...
                editor.addListener('selectionchange', function (t, causeByUi) {
                    ...
                    if (img && img.tagName == 'IMG') {
                        ...
                        str = '<nobr>' + editor.getLang("property") + ': '+
                            ...
                            '<span onclick=$$._onImgSetFloat("center") class="edurli-clickable">' + editor.getLang("justifycenter") + '</span>&nbsp;&nbsp;'+
                            '<span onclick="$$._onImgEditButtonClick(\'' + dialogName + '\');" class="edui-clickable">' + editor.getLang("modify") + '</span>&nbsp;&nbsp;'+
                            '<span onclick="$$._onImgClearButtonClick(\'' + img.src + '\');" class="edui-clickable">' + editor.getLang("clear") + '</span></nobr>';
...
UE.commands['imagedel'] = {
    execCommand:function (cmd, value) {
        ...
        if (!range.collapsed) {
            ...
            xhr.open('GET', "../ueditor/php/fileDel.php?name="+value.substring(value.indexOf('upload')), true);
            xhr.send(null);
