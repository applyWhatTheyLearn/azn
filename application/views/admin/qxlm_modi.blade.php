...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr bgcolor="#E4E4E4">
    <td height="246" valign="top">
        <form name="form1" method="post" action="qxlm_modi.html">
          <table width="740" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
              ...
              <td colspan="2" bgcolor="F1F0F1"><input name="titlename_t" type="text" id="titlename_t" value='{{Input::old('titlename_t')?Input::old('titlename_t'):$menu->titlename_t}}'  size="20" maxlength="15"></td>
            </tr>
            <tr>
              <td height="22" bgcolor="F1F0F1">&nbsp;连接文件名：</td>
              <td colspan="2" bgcolor="F1F0F1"><font color="#990000">
                <input name="linkname_t" type="text" id="linkname_t" value='{{Input::old('linkname_t')?Input::old('linkname_t'):$menu->linkname_t}}' size="60" maxlength="50">
                </font></td>
            </tr>
            <tr>
              <td height="22" bgcolor="F1F0F1">&nbsp;排序：</td>
              <td colspan="2" bgcolor="F1F0F1"><input name="compositor_t" type="text" id="compositor_t" value='{{Input::old('compositor_t')?Input::old('compositor_t'):$menu->compositor_t}}' size="20" maxlength="15"></td>
            </tr>
            <tr>
              <td height="46" bgcolor="F1F0F1"><div align="center"></div></td>
              <td height="46" colspan="2" bgcolor="F1F0F1">
                <input type="hidden" name="accid_t" value="{{$menu->accid_t}}">
