  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="#E4E4E4"> 
      <td height="246" valign="top"> 
          <form action="link_modi.html" method="post" name="sample" id="sample">
            <table width="770" border="0" cellspacing="1" cellpadding="0">
              <tr> 
                ...
                <td width="107" bgcolor="#FFFFFF"><div align="center"><a href="link_list.html?page={{$page}}">返回前页</a></div></td>
              </tr>
              <tr> 
              ...
              <tr>
                ...
                <td height="22" colspan="2" bgcolor="F1F0F1"><font size="2">
                  <input name="w_name" type="text" id="w_name" value="{{$link->w_name}}" size="30" maxlength="50">
                </font></td>
              </tr>
              <tr> 
                <td height="22" bgcolor="F1F0F1"><font size="2">&nbsp;连接URL：</font></td>
                <td colspan="2" bgcolor="F1F0F1"><font size="2">
                  <input name="w_url" type="text" id="w_url" value="{{$link->w_url}}" size="50" maxlength="50">
              ...
              <tr>
                ...
                <td height="6" colspan="2" valign="top" bgcolor="F1F0F1"><font size="2">
                  <input name="w_sort" type="text" id="w_sort" value="{{$link->w_sort}}" size="20" maxlength="6">
                </font></td>
              </tr>
              <tr> 
                ...
                <td height="23" colspan="2" bgcolor="F1F0F1"><font size="2"> &nbsp;显示 <input name="w_views" type="radio" value="显示"
                                                                                       @if (trim($link->w_views) == '显示' ) checked="CHECKED" @endif>不显示 <input type="radio" name="w_views" value="不显示"
                                                                                       @if (trim($link->w_views) == '不显示' ) checked="CHECKED" @endif> </font></td>
              </tr>
              <tr> 
                <td height="46" bgcolor="F1F0F1">&nbsp;</td>
                <td height="46" colspan="2" bgcolor="F1F0F1">
                  <input type="submit" name="Submit" value="修改">
                   <input type="hidden" name="w_id" value="{{$link->w_id}}">
                       <input type="hidden" name="page" value="{{$page}}">
                  <input type="button" name="Submit3" value="返回前页" onClick="location='link_list.html?page={{$page}}'"></td>
              </tr>
              <tr> 
