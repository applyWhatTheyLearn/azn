    ...
    <tr bgcolor="#E4E4E4"> 
      <td height="230" valign="top">
          <table width="770" border="0" cellspacing="1" cellpadding="0">
            <tr> 
              <td width="133" height="21" bgcolor="#A24E12">&nbsp;<font color="#FFFFFF">友情连接列表</font></td>
                <td width="514" bgcolor="#FFFFFF">&nbsp;</td>
                <td width="89" align="right" bgcolor="#FFFFFF"><a href="link_add.html?page={{$page}}">添加友情连接</a></td>
            </tr>
          </table>
          <table width="770" border="0" cellpadding="0" cellspacing="1">
            ...
            <tr> 
              ...
              <td height="20" bgcolor="F1F0F1">&nbsp;<a href="http://{{$link->w_url}}" target="_blank">{{$link->w_name}}</a></td>
              <td height="20" bgcolor="F1F0F1">&nbsp;{{$link->w_sort}}</td>
              <td height="20" bgcolor="F1F0F1"> 
              <div align="center"><font >{{$link->w_views}}</font></div></td>
              <td height="20" bgcolor="F1F0F1"> <div align="center"><a href="link_modi.html?w_id={{$link->w_id}}&page={{$page}}"><font size="2">修改</font></a></div></td>
              <td height="20" bgcolor="F1F0F1"> <div align="center"><a href="link_del.html?w_id={{$link->w_id}}&page={{$page}}"> 
                  删除</a></div></td>
            </tr>
            <tr> 
