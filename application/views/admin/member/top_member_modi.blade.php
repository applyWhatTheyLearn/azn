          ...
          <form action="auClass_add_sub.asp" method="post" name="sample" id="sample">
            <table width="700" border="0" cellspacing="1" cellpadding="0">
              ...
              <tr>
                ...
                <td height="22" colspan="2" valign="middle" bgcolor="#C8E3FF"><input name="username" type="text" id="username" value="张三" size="30" maxlength="20">
                <font color="#FF0000">*</font></td>
              </tr>
              <tr>
                <td valign="middle" bgcolor="#C8E3FF"><font size="2">&nbsp;会员密码:</font></td>
                <td height="22" colspan="2" valign="middle" bgcolor="#C8E3FF"><input name="userpass" type="text" id="userpass" value="123456" size="30" maxlength="20">
                <font color="#FF0000">*</font></td>
              </tr>
              <tr>
                <td height="21" valign="middle" bgcolor="#C8E3FF"><font size="2">&nbsp;确认密码:</font></td>
                <td height="21" colspan="2" valign="middle" bgcolor="#C8E3FF"><input name="reuserpass" type="text" id="reuserpass" value="123456" size="30" maxlength="20">
                <font color="#FF0000">*</font></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td height="21" colspan="2" valign="middle" bgcolor="#C8E3FF"><input name="idcard1" type="text" id="idcard1" value="123456789012345678990" size="40" maxlength="20">
                <font color="#FF0000">*</font></td>
              </tr>
              <tr>
                <td height="21" valign="middle" bgcolor="#C8E3FF"><font size="2">&nbsp;Email:</font></td>
                <td height="21" colspan="2" valign="middle" bgcolor="#C8E3FF"><input name="email" type="text" id="email" value="123@email.com" size="40" maxlength="100">
                <font color="#FF0000">*</font></td>
              </tr>
              <tr>
                <td height="21" valign="middle" bgcolor="#C8E3FF"><font size="2">&nbsp;学历:</font></td>
                <td height="21" colspan="2" valign="middle" bgcolor="#C8E3FF"><input name="educational" type="text" id="educational" value="本科" size="20" maxlength="25"></td>
              </tr>
              <tr>
                <td height="21" valign="middle" bgcolor="#C8E3FF"><font size="2">&nbsp;现职业:</font></td>
                <td height="21" colspan="2" valign="middle" bgcolor="#C8E3FF"><input name="profession1" type="text" id="profession1" value="市场销售" size="20" maxlength="20"></td>
              </tr>
              <tr>
                <td height="21" valign="middle" bgcolor="#C8E3FF"><font size="2">&nbsp;单位名称:</font></td>
                <td height="21" colspan="2" valign="middle" bgcolor="#C8E3FF"><input name="company_name" type="text" id="company_name" value="北京XXX有限公司" size="40" maxlength="100"></td>
              </tr>
              <tr>
                <td height="21" valign="middle" bgcolor="#C8E3FF"><font size="2">&nbsp;工作地:</font></td>
                <td height="21" colspan="2" valign="middle" bgcolor="#C8E3FF"><input name="work_address" type="text" id="work_address" value="北京" size="40" maxlength="20"></td>
              </tr>
              <tr>
                <td height="21" valign="middle" bgcolor="#C8E3FF"><font size="2">&nbsp;联系地址:</font></td>
                <td height="21" colspan="2" valign="middle" bgcolor="#C8E3FF"><input name="address" type="text" id="address" value="北京市西城区XXX胡同2号" size="50" maxlength="100"></td>
              </tr>
              <tr>
                <td height="21" valign="middle" bgcolor="#C8E3FF"><font size="2">&nbsp;现邮政编码</font></td>
                <td height="21" colspan="2" valign="middle" bgcolor="#C8E3FF"><input name="postcode1" type="text" id="postcode1" value="100035" size="20" maxlength="6"></td>
              </tr>
              <tr>
                <td height="21" valign="middle" bgcolor="#C8E3FF"><font size="2">&nbsp;固定电话</font></td>
                <td height="21" colspan="2" valign="middle" bgcolor="#C8E3FF"><input name="tel" type="text" id="tel" value="010-12345678" size="30" maxlength="50"></td>
              </tr>
              <tr>
                <td height="21" valign="middle" bgcolor="#C8E3FF"><font size="2">&nbsp;移动电话</font></td>
                <td height="21" colspan="2" valign="middle" bgcolor="#C8E3FF"><input name="mobile" type="text" id="mobile" value="123456789012" size="30" maxlength="50">
                <font color="#FF0000">*</font></td>
              </tr>
              <tr>
                <td height="21" valign="middle" bgcolor="#C8E3FF"><font size="2">&nbsp;常用住址</font></td>
                <td height="21" colspan="2" valign="middle" bgcolor="#C8E3FF"><input name="commonly_address" type="text" id="commonly_address" value="省/直辖市/自治区" size="50" maxlength="100">
                省/直辖市/自治区</td>
              </tr>
              <tr>
                <td height="21" valign="middle" bgcolor="#C8E3FF"><font size="2">&nbsp;常用住址邮编</font></td>
                <td height="21" colspan="2" valign="middle" bgcolor="#C8E3FF"><input name="postcode2" type="text" id="postcode2" value="100018" size="20" maxlength="6"></td>
              </tr>
              <tr>
                <td height="21" valign="middle" bgcolor="#C8E3FF"><font size="2">&nbsp;直系家属姓名</font></td>
                <td height="21" colspan="2" valign="middle" bgcolor="#C8E3FF"><input name="Immediate_family_name" type="text" id="Immediate_family_name" value="王某某" size="20" maxlength="16"></td>
              </tr>
              <tr>
                <td height="21" valign="middle" bgcolor="#C8E3FF"><font size="2">&nbsp;职业</font></td>
                <td height="21" colspan="2" valign="middle" bgcolor="#C8E3FF"><input name="Profession2" type="text" id="Profession2" value="医生" size="20" maxlength="40"></td>
              </tr>
              <tr>
                <td height="21" valign="middle" bgcolor="#C8E3FF"><font size="2">&nbsp;家属身份证</font></td>
                <td height="21" colspan="2" valign="middle" bgcolor="#C8E3FF"><input name="idcard2" type="text" id="idcard2" value="123456789012345678990" size="40" maxlength="20"></td>
              </tr>
              <tr>
                <td height="21" valign="middle" bgcolor="#C8E3FF"><font size="2"></font>&nbsp;MSN</td>
                <td height="21" colspan="2" valign="middle" bgcolor="#C8E3FF"><input name="msn" type="text" id="msn" value="123@hotmail.com" size="40" maxlength="100"></td>
              </tr>
              <tr>
                <td height="21" valign="middle" bgcolor="#C8E3FF"><font size="2">&nbsp;QQ</font></td>
                <td height="21" colspan="2" valign="middle" bgcolor="#C8E3FF"><input name="qq" type="text" id="qq" value="123456789" size="40" maxlength="20"></td>
              </tr>
              <tr>
                <td height="21" valign="middle" bgcolor="#C8E3FF"><font size="2">&nbsp;微信帐号</font></td>
                <td height="21" colspan="2" valign="middle" bgcolor="#C8E3FF"><input name="weixin" type="text" id="weixin" value="winxin123" size="40" maxlength="20"></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td height="21" colspan="2" valign="middle" bgcolor="#99CCCC"><input name="clearing_bank" type="text" id="clearing_bank" value="北京工商银行" size="20" maxlength="20"></td>
              </tr>
              <tr>
                <td height="21" valign="middle" bgcolor="#99CCCC"><font size="2">&nbsp;分行</font></td>
                <td height="21" colspan="2" valign="middle" bgcolor="#99CCCC"><input name="branch" type="text" id="branch" value="朝阳支行" size="20" maxlength="30"></td>
              </tr>
              <tr>
                <td height="21" valign="middle" bgcolor="#99CCCC"><font size="2">&nbsp;户名</font></td>
                <td height="21" colspan="2" valign="middle" bgcolor="#99CCCC"><input name="account_name" type="text" id="account_name" value="某某某" size="20" maxlength="50"></td>
              </tr>
              <tr>
                <td height="21" valign="middle" bgcolor="#99CCCC"><font size="2">&nbsp;帐号</font></td>
                <td height="21" colspan="2" valign="middle" bgcolor="#99CCCC"><input name="account_number" type="text" id="account_number" value="01234567890" size="40" maxlength="20"></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                否
                <input name="question2" type="radio" value="否">
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                否
                <input name="question3" type="radio" value="否">
                </td>
              </tr>
              <tr>
