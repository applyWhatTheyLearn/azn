  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="#E4E4E4">
      <td height="246" valign="top" bgcolor="#E4E4E4">
          <form action="area_add.html" method="post" name="sample" id="sample">
            <table width="770" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td height="21" bgcolor="#A24E12">&nbsp;<font color="#FFFFFF">添加区域</font></td>
              ...
              <tr>
                <td valign="top" bgcolor="F1F0F1"><font size="2">&nbsp;区域名称:</font></td>
                <td height="22" colspan="2" bgcolor="F1F0F1"><input name="w_name" type="text" id="w_name" size="30" maxlength="20"></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <input type="button" name="Submit3" value="返回前页" onClick="location='area_list.html?page={{$page}}'"></td>
              </tr>
              <tr>
