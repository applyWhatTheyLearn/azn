  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="#E4E4E4"> 
      <td height="246" valign="top"> 
          <form action="join_modi.html" method="post" name="sample" id="sample">
            <table width="700" border="0" cellspacing="1" cellpadding="0">
              ...
              <tr>
         <textarea name='w_detail' id="w_detail" >{{$join->w_detail}}</textarea>
         <script type="text/javascript">UE.getEditor('w_detail')</script>
              </tr>
              <tr>
                <td height="46" bgcolor="F1F0F1">&nbsp;</td>
                <td height="46" bgcolor="F1F0F1">
         <input type="hidden" name="w_id" value="{{$join->w_id}}">
