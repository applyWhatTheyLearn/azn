  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="#E4E4E4"> 
      <td height="246" valign="top"> 
          <form action="help_modi.html" method="post" name="sample" id="sample">
            <table width="700" border="0" cellspacing="1" cellpadding="0">
              ...
              <tr>
                ...
                <td height="21" colspan="2" valign="top" bgcolor="F1F0F1"><input name="w_title" type="text" id="w_title" value="{{$detail->w_title}}" size="50" maxlength="50"></td>
              </tr>
              <tr>
                <td height="309" valign="top" bgcolor="F1F0F1"><font size="2">&nbsp;详细内容：</font></td>
                <td height="309" colspan="2" valign="top" bgcolor="F1F0F1">
                  <textarea name='w_detail' id="w_detail" >{{$detail->w_detail}}</textarea>
                     <script type="text/javascript">UE.getEditor('w_detail')</script></td>
              </tr>
              <tr>
                <td height="21" valign="top" bgcolor="F1F0F1"><font size="2">&nbsp;排序：</font></td>
                <td height="21" colspan="2" valign="top" bgcolor="F1F0F1"><input name="w_sort" type="text" id="w_sort" value="{{$detail->w_sort}}" size="25" maxlength="6">
              ...
              <tr>
                ...
                @if (trim($detail->w_views) == '显示' ) checked="CHECKED" @endif>不显示 <input type="radio" name="w_views" value="不显示"
                @if (trim($detail->w_views) == '不显示' ) checked="CHECKED" @endif> </font></td>
              </tr>
              <tr>
                <td height="46" bgcolor="F1F0F1">&nbsp;</td>
                <td height="46" colspan="2" bgcolor="F1F0F1">
                  <input type="hidden" name="w_id" value="{{$detail->w_id}}">
         <input type="hidden" name="page" value="{{$page}}">
         <input type="hidden" name="w_classid" value="{{$class->w_id}}">
                  <input type="submit" name="Submit" value="修改">
                    <input type="button" name="Submit3" value="返回前页" onClick="location='help_list.html?w_id={{$detail->w_id}}&page={{$page}}?w_classid={{$class->w_id}}'"></td>
              </tr>
