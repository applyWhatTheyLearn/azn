...
<form action="pro_add.html" method="post" name="sample" id="sample"  onSubmit="return CheckForm(this);">
...
<tr>
    ...
    <td height="100" colspan="2" valign="top" bgcolor="F1F0F1"><textarea name='l_basic' id="l_basic" ></textarea>
                 <script type="text/javascript">UE.getEditor('l_basic')</script></td>
</tr>
<tr>
    <td height="23" valign="top" bgcolor="F1F0F1"><font size="2">&nbsp;商品介绍：</font></td>
    <td height="100" colspan="2" valign="top" bgcolor="F1F0F1"><textarea name='l_extend' id="l_extend" ></textarea>
                 <script type="text/javascript">UE.getEditor('l_extend')</script></td>
</tr>
<tr>
    <td height="23" valign="top" bgcolor="F1F0F1"><font size="2">&nbsp;规格参数：</font></td>
    <td height="100" colspan="2" valign="top" bgcolor="F1F0F1">
                <textarea name='l_specifications' id="l_specifications" ></textarea>
...
<tr>
    ...
    <td height="23" colspan="2" bgcolor="F1F0F1"><input name="units" type="text" id="l_units" value="0" size="25" maxlength="10"></td>
</tr>
<tr>
...
<tr>
    ...
    <td height="46" colspan="2" bgcolor="F1F0F1">
                 ...
                 <input type="hidden" name="l_number" value="{{$l_number}}">
