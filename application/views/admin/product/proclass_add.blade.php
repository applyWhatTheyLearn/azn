  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="#E4E4E4">
      <td height="246" valign="top" bgcolor="#E4E4E4">
          <form action="proClass_add.html" method="post" name="sample" id="sample">
            <table width="700" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td height="21" bgcolor="#A24E12">&nbsp;<font color="#FFFFFF">添加分类</font></td>
                <td width="531" height="21" bgcolor="#FFFFFF">&nbsp;</td>
                <td width="106" bgcolor="#FFFFFF"><div align="center"><a href="proClass_managelist.html?areaid={{$area->w_id}}">返回分类列表</a></div></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td height="22" colspan="2" bgcolor="F1F0F1"><input name="w_classname" type="text" id="w_classname" size="30" maxlength="25"></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td height="46" colspan="2" bgcolor="F1F0F1">
                  ...
                  <input type="hidden" name="l_fid" value="{{$l_fid}}">
                  <input type="hidden" name="areaid" value="{{$area->w_id}}">
                   <input type="hidden" name="type" value="{{$type}}">
                   <input type="hidden" name="additional_fid" value="{{$additional_fid}}">
                  <input type="submit" name="Submit" value="添加">
                  <input type="button" name="Submit3" value="返回分类列表" onClick="location='proClass_managelist.html?areaid={{$area->w_id}}'"></td>
              </tr>
              <tr>
