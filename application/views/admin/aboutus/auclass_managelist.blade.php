    ...
    <tr bgcolor="#E4E4E4"> 
     ...
     @foreach($classes as $class )
            <tr> 
              ...
              <td valign="bottom" bgcolor="F1F0F1"><div align="center"><a href="auClass_modi.html?w_id={{$class->w_id}}">修改</a></div></td>
              <td height="18" valign="bottom" bgcolor="F1F0F1"><div align="center"><a href="auClass_del.html?w_id={{$class->w_id}}">删除</a></div></td>
            </tr>
            <tr> 
