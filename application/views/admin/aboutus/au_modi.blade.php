  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="#E4E4E4"> 
      <td height="246" valign="top"> 
          <form action="au_modi.html" method="post" name="sample" id="sample">
            <table width="700" border="0" cellspacing="1" cellpadding="0">
              <tr>
                ...
                <td width="103" bgcolor="#FFFFFF"><div align="center"><a href="au_list.html?w_id={{$detail->w_id}}&page={{$page}}&w_classid={{$class->w_id}}">返回前页</a></div></td>
              </tr>
              <tr>
         ...
         <input type="submit" name="Submit" value="修改">
                    <input type="button" name="Submit3" value="返回前页" onClick="location='au_list.html?w_id={{$detail->w_id}}&page={{$page}}?w_classid={{$class->w_id}}'"></td>
              </tr>
