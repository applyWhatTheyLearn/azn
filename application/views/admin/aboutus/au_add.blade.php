...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="#E4E4E4"> 
      <td height="246" valign="top" bgcolor="#E4E4E4"> 
          <form action="au_add.html" method="post" name="sample" id="sample">
            <table width="700" border="0" cellspacing="1" cellpadding="0">
              <tr> 
                ...
                <td width="73" bgcolor="#FFFFFF"><div align="center"><a href="au_list.html?page={{$page}}&w_classid={{$class->w_id}}">返回前页</a></div></td>
              </tr>
              <tr> 
              ...
              <tr>
                ...
                <td height="21" colspan="2" valign="top" bgcolor="F1F0F1">
                  <input name="w_sort" type="text" id="w_sort" value="0" size="25" maxlength="6"> 
              ...
              <tr> 
                ...
                <td height="46" colspan="2" bgcolor="F1F0F1">
                  ...
                  <input type="submit" name="Submit" value="添加">
                    <input type="button" name="Submit3" value="返回前页" onClick="location='au_list.html?page={{$page}}&w_classid={{$class->w_id}}'"></td>
              </tr>
              <tr> 
