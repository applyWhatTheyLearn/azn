    ...
    <tr bgcolor="#E4E4E4"> 
      <td height="230" valign="top">
          <table width="700" border="0" cellspacing="1" cellpadding="0">
            <tr> 
              <td width="134" height="21" bgcolor="#006699">&nbsp;<font color="#FFFFFF">关于我们内容列表</font></td>
              <form name="form1" method="post" action="au_list.html">
                <td width="494" bgcolor="#FFFFFF">&nbsp;所属分类：[ <span class="STYLE3">{{$class->w_classname}}</span> ]</td>
                <td width="68" bgcolor="#FFFFFF"><div align="center"><a href="au_add.html?page={{$page}}&w_classid={{$class->w_id}}">添加内容</a></div></td>
              </form>
            </tr>
            <tr>
         ...
         @foreach($details->results as $detail)
            <tr> 
              ...
              <td height="18" valign="bottom" bgcolor="F1F0F1">&nbsp;<a href="au_detail.html?w_id={{$detail->w_id}}&page={{$page}}&w_classid={{$class->w_id}}" ><font color="#990000">{{$detail->w_title}}</font></a></td>
              ...
              <td valign="bottom" bgcolor="F1F0F1"><div align="center">
                <div align="center"><a href="au_modi.html?w_id={{$detail->w_id}}&page={{$page}}&w_classid={{$class->w_id}}"><font size="2">修改</font></a></div>
                <a href="au_modi.html?w_id={{$detail->w_id}}&page={{$page}}"><font size="2"></font></a></div>
             </td>
            <td valign="bottom" bgcolor="F1F0F1"> <div align="center"><a href="au_del.html?w_id={{$detail->w_id}}&page={{$page}}&w_classid={{$class->w_id}}"> 
              删除</a></div></td>
            </tr>
            <tr> 
