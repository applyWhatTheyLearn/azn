<html>
<NOSCRIPT> 
<IFRAME src="Draw_pic.html"> </IFRAME>
</NOSCRIPT>
<head>
...
<TABLE border=0 cellPadding=0 cellSpacing=0 height=100% width=100%>
  <TBODY>
    <TR>
	  ...
	  <IFRAME frameBorder=0 name=window_left scrolling="yes" src=auClass_List.html  style="HEIGHT:100%;VISIBILITY:inherit;WIDTH:200px;Z-INDEX:2" target="main">
	  </IFRAME>
      <TD bgColor=#CCCCCC>
       ...
       <TD style="WIDTH:100%">
	   <IFRAME frameBorder=0 name=window_main scrolling="auto" src="au_temp.html" style="HEIGHT:100%;VISIBILITY:inherit;WIDTH:100%;Z-INDEX:1"></IFRAME>
    </TR>
	 </TBODY>
	</TABLE>
</body></html>
