      ...
      <td height="246" valign="top" bgcolor="#E4E4E4"> 
            <table width="700" border="0" cellspacing="1" cellpadding="0">
              ...
              <tr>
                ...
                <td height="46" colspan="2" bgcolor="F1F0F1"><input type="button" name="Submit3" value="返回前页" onClick="location='au_list.html?w_id={{$detail->w_id}}&page={{$page}}&w_classid={{$class->w_id}}'"></td>
              </tr>
              <tr>
