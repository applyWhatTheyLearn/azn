...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="#E4E4E4"> 
      <td height="246" valign="top" bgcolor="#E4E4E4"> 
          <form action="gonggao_add_sub.html" method="post" name="sample" id="sample">
            <table width="700" border="0" cellspacing="1" cellpadding="0">
              <tr> 
                <td height="21" bgcolor="#996600">&nbsp;<font color="#FFFFFF">添加区域公告</font></td>
                <td width="480" height="21" bgcolor="#FFFFFF">&nbsp;</td>
                <td width="115" bgcolor="#FFFFFF"><div align="center"><a href="area_gonggao_list.html">返回区域公告列表</a></div></td>
              </tr>
              <tr></tr>
              <tr> 
              ...
              <tr> 
                ...
                <input type="button" name="Submit3" value="返回前页" onClick="location='area_gonggao_list.html?page={{$page}}'"></td>
              </tr>
              <tr> 
