  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="#E4E4E4">
      <td height="246" valign="top">
          <form name="form1" method="post" action="user_modi.html">
            <table width="740" border="0" cellspacing="1" cellpadding="0">
              <tr>
                ...
                <td width="104" bgcolor="#FFFFFF"><div align="center"><a href="user_list.html?page={{$page}}">返回前页</a></div></td>
              </tr>
              <tr>
...
<div align="right"></div></td>
              ...
              <tr>
                ...
                <td colspan="2" bgcolor="F1F0F1"><input name="username" type="text" id="username"
                                                        value='{{Input::old('username')?Input::old('username'):$user->username}}' 
                                                        size="20" maxlength="15"> {{$errors->first('username')}}</td>
              </tr>
              <tr>
                ...
                <td colspan="2" bgcolor="F1F0F1"><font color="#990000">
                  ...
                  * {{$errors->first('password')}}</font></td>
                </tr>
              <tr>
                <td height="22" bgcolor="F1F0F1">&nbsp;重复密码：</td>
                <td colspan="2" bgcolor="F1F0F1"><input name="password_confirmation" type="password" id="password_confirmation" size="40" maxlength="15">
