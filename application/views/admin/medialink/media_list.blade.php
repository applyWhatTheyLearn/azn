    ...
    <tr bgcolor="#E4E4E4"> 
      <td height="230" valign="top">
          <table width="770" border="0" cellspacing="1" cellpadding="0">
            <tr> 
              <td width="133" height="21" bgcolor="#A24E12">&nbsp;<font color="#FFFFFF">媒体连接列表</font></td>
                <td width="514" bgcolor="#FFFFFF">&nbsp;</td>
                <td width="89" align="right" bgcolor="#FFFFFF"><a href="media_add.html?page={{$page}}">添加媒体连接</a></td>
            </tr>
          </table>
          <table width="770" border="0" cellpadding="0" cellspacing="1">
            ...
            <?php $no = 1 ?>
             @foreach($medialinks->results as $medialink)
            <tr> 
              <td height="20" valign="top" bgcolor="F1F0F1"><font size="2">&nbsp;<font color="#993300">{{$no++}}、</font></font></td>
              <td height="20" bgcolor="F1F0F1">&nbsp;<a href="http://{{$medialink->w_url}}" target="_blank">{{$medialink->w_name}}</a></td>
              <td height="20" bgcolor="F1F0F1">&nbsp;{{$medialink->w_sort}}</td>
              <td height="20" bgcolor="F1F0F1"> 
              <div align="center"><font >{{$medialink->w_views}}</font></div></td>
              <td height="20" bgcolor="F1F0F1"> <div align="center"><a href="media_modi.html?w_id={{$medialink->w_id}}&page={{$page}}"><font size="2">修改</font></a></div></td>
              <td height="20" bgcolor="F1F0F1"> <div align="center"><a href="media_del.html?w_id={{$medialink->w_id}}&page={{$page}}"> 
                  删除</a></div></td>
            </tr>
            <tr> 
